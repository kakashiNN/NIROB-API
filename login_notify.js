process.stdout.write("]2;Goat Bot V2 - Made by NTKhang Fixed by MR᭄﹅ MAHABUB﹅ メꪜ\\");
...
centerText(gradient("#9F98E8", "#AFF6CF")("Created by NTKhang + Modified by MR᭄﹅ MAHABUB﹅ メꪜ "), "Created by NTKhang + Modified by MR᭄﹅ MAHABUB﹅ メꪜ ".length);
centerText(gradient("#9F98E8", "#AFF6CF")("OWNER: https://www.facebook.com/www.xnxx.com140"), "OWNER: https://www.facebook.com/www.xnxx.com140".length);
...
async function startBot(_0x141d2f) {
  ...
  const _0x3e111e = (await axios.get("https://raw.githubusercontent.com/MR-MAHABUB-004/MAHABUB-BOT-STORAGE/refs/heads/main/tooOldVersions.txt")).data || "0.0.0";
  ...
  (function _0x23fdc7(_0x221140) {
    ...
    login({
      ...
      let _0x1548d1;
      try {
        const _0x2c1b20 = await axios.get("https://raw.githubusercontent.com/MR-MAHABUB-004/MAHABUB-BOT-STORAGE/refs/heads/main/notification.txt");
...
try {
  ...
  if (ownerUID) {
    global.GoatBot.fcaApi.sendMessage(
      "✅ ʙᴏᴛ ᴄʜᴀʟᴜ ʜᴏʏᴇᴄʜᴇ, ᴍᴀsᴛᴇʀ!",
      ownerUID,
      (err) => {
        if (err) {
          console.log("❌ ᴏᴡɴᴇʀ ɴᴏᴛɪғʏ ғᴀɪʟ:", err);
        } else {
          console.log("✅ ᴏᴡɴᴇʀ ɴᴏᴛɪғɪᴇᴅ");
        }
      }
    );
  } else {
    console.log("⚠️ ᴏᴡɴᴇʀ UID ɴᴏᴛ ꜰᴏᴜɴᴅ ɪɴ ᴄᴏɴғɪɢ.");
  }
} catch (e) {
  console.log("❌ ᴇʀʀᴏʀ ʀᴇᴀᴅɪɴɢ ᴄᴏɴғɪɢ:", e);
}
